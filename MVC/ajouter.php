<?php
	...
	$sql= "INSERT INTO location_vente(name, localisation, description, price, energy, greenhouseg, location, image) VALUES ('".$_POST['nom']."', '".$_POST['localisation']."', '".$_POST['description']."', ".$_POST['prix']." , '".$_POST['energie']."' , '".$_POST['effetserre']."', '".$_POST['location']."','".file_get_contents($_POST['image'])."')";
